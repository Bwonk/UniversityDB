...
CREATE TABLE Ogrenci(
	...
	danýsman_id INT,
	FOREIGN KEY (bolum_id) REFERENCES Bolum(bolum_id),
	FOREIGN KEY (danýsman_id) REFERENCES Hoca(hoca_id)
...
CREATE TABLE Notlar (
   ...
   sýnav_id INT,
   notu INT ,
   PRIMARY KEY (ogrenci_id , sýnav_id),
   FOREIGN KEY (ogrenci_id) REFERENCES Ogrenci(ogrenci_id),
   FOREIGN KEY(sýnav_id) REFERENCES Sýnav(sýnav_id)
